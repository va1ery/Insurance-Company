...
namespace Insurance_Company.Data
{
    public static class DbInitializer
    {
        public static void Initialize(InsuranceCompanyContext context)
        {
            ...
            var Klienty = new Klient[]
            {
            new
Klient{FirstMidName="Ivan",LastName="Yasenev",DataRozhdeniya=DateTime.Parse("1975-09-05")},
            new
Klient{FirstMidName="Anna",LastName="Alonso",DataRozhdeniya=DateTime.Parse("1986-12-25")},
            new
Klient{FirstMidName="Peter",LastName="Nikitin",DataRozhdeniya=DateTime.Parse("1974-04-01")},
            new
Klient{FirstMidName="Michael",LastName="Barzdukas",DataRozhdeniya=DateTime.Parse("1988-07-26")},
            new
Klient{FirstMidName="Maria",LastName="Scriabina",DataRozhdeniya=DateTime.Parse("1968-09-01")},
            new
Klient{FirstMidName="Alena",LastName="Arsenieva",DataRozhdeniya=DateTime.Parse("1983-03-11")},
            new
Klient{FirstMidName="Juliana",LastName="Kashnikova",DataRozhdeniya=DateTime.Parse("1990-09-20")},
            new
Klient{FirstMidName="Alexander",LastName="Pugachev",DataRozhdeniya=DateTime.Parse("1977-12-31")}
            };
            foreach (Klient s in Klienty)
            {
