        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Data_rozdeniya = table.Column<byte[]>(type: "DATETIME", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FIO = table.Column<string>(type: "VARCHAR(50)", nullable: false),
                    Data_rozhdeniya = table.Column<byte[]>(type: "DATETIME", nullable: false),
                    Pol = table.Column<string>(type: "CHAR(1)", nullable: false),
                    Adres = table.Column<string>(type: "VARCHAR(100)", nullable: false),
                    Telefon = table.Column<string>(type: "VARCHAR(11)", nullable: false),
                    Pasportnye_dannye = table.Column<string>(type: "VARCHAR(50)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Data_nachala = table.Column<byte[]>(type: "DATETIME", nullable: false),
                    Data_okonchaniya = table.Column<byte[]>(type: "DATETIME", nullable: false),
